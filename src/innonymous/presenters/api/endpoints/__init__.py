...
from innonymous.presenters.api.endpoints.captcha import router as captcha  # noqa: E402
...
from innonymous.presenters.api.endpoints.users import router as users  # noqa: E402

router.include_router(captcha)
